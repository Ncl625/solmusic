<template>
        ...
        <!-- Player section -->
	<section class="player-section set-bg" data-setbg="../assets/img/player-bg.jpg">
		<div class="player-box">
			<div class="tarck-thumb-warp">
				<div class="tarck-thumb">
					<img src="../assets/img/wave-thumb.jpg" alt="">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="songs-links">
							<a href=""><img src="../assets/img/icons/p-1.png" alt=""></a>
							<a href=""><img src="../assets/img/icons/p-2.png" alt=""></a>
							<a href=""><img src="../assets/img/icons/p-3.png" alt=""></a>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-6">
							<div class="song-details-box">
								...
								<div class="artist-details">
									<img src="../assets/img/artist.jpg" alt="">
									<div class="ad-text">
										<h5>Michael Smith</h5>
							...
							<div class="song-details-box">
									...
									<div class="row">
										<div class="col-xl-5 col-lg-12 col-md-5">
											<div class="song-info-box">
												<img src="../assets/img/songs/1.jpg" alt="">
												<div class="song-info">
								...
								<div class="song-item">
									<div class="row">
										<div class="col-xl-5 col-lg-12 col-md-5">
											<div class="song-info-box">
												<img src="../assets/img/songs/2.jpg" alt="">
												<div class="song-info">
													<h4>Michael Smith</h4>
													<p>Dream in colors</p>
												</div>
			...
			<div class="row">
				<div class="col-xl-3 col-sm-6">
					<div class="similar-song">
						<img class="ss-thumb" src="../assets/img/playlist/1.jpg" alt="">
						<h4>Jennifer Brown</h4>
						<p>One Night in Ibiza</p>
						<div class="single_player">
				...
				<div class="col-xl-3 col-sm-6">
					<div class="similar-song">
						<img class="ss-thumb" src="../assets/img/playlist/2.jpg" alt="">
						<h4>Jennifer Brown</h4>
						<p>One Night in Ibiza</p>
						<div class="single_player">
				...
				<div class="col-xl-3 col-sm-6">
					<div class="similar-song">
						<img class="ss-thumb" src="../assets/img/playlist/3.jpg" alt="">
						<h4>Jennifer Brown</h4>
						<p>One Night in Ibiza</p>
						<div class="single_player">
				...
				<div class="col-xl-3 col-sm-6">
					<div class="similar-song">
						<img class="ss-thumb" src="../assets/img/playlist/4.jpg" alt="">
						<h4>Jennifer Brown</h4>
						<p>One Night in Ibiza</p>
						<div class="single_player">
